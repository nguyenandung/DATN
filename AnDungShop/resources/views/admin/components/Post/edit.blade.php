            ...
            <div class="col-3">
                <div style="width: 100%; height:100px;" class="bg-white ">
                    <div class="p-3">
                        ...
                        @error('status')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                        <input class="my-2 me-1 " type="radio" name="status" id="" value="0"
                            {{ $post->status == 0 ? 'checked' : '' }}><span>Ẩn</span>
                        <br>
                        <input class="me-1" type="radio" name="status" id="" value="1"
                            {{ $post->status == 1 ? 'checked' : '' }}><span>Hiện
                            thị</span>
                    </div>
                </div>
                <div class="mt-2 bg-white p-2" style="width: 100%; height: auto;">
                    ...
                    <div class=" d-flex justify-content-center align-items-center h-100 flex-column ">
                        ...
                        <img id="previewImage" src="{{ asset('assets/uploads/' . $post->image) }}" alt="">
                    </div>
